...
set(CPACK_PACKAGE_VERSION_MAJOR ${NCPONG_MAJOR_VERSION})
set(CPACK_PACKAGE_VERSION_MINOR ${NCPONG_MINOR_VERSION})
set(CPACK_PACKAGE_VERSION_PATCH ${NCPONG_PATCH_VERSION})
...
elseif(UNIX AND NOT APPLE)
	...
	if(EXISTS ${NCPONG_DATA_DIR}/icons)
		install(FILES ${NCPONG_DATA_DIR}/icons/icon1024.png DESTINATION ${ICONS_INSTALL_DESTINATION}/1024x1024/apps/ RENAME ncPong.png)
		install(FILES ${NCPONG_DATA_DIR}/icons/icon192.png DESTINATION ${ICONS_INSTALL_DESTINATION}/192x192/apps/ RENAME ncPong.png)
		install(FILES ${NCPONG_DATA_DIR}/icons/icon96.png DESTINATION ${ICONS_INSTALL_DESTINATION}/96x96/apps/ RENAME ncPong.png)
		install(FILES ${NCPONG_DATA_DIR}/icons/icon72.png DESTINATION ${ICONS_INSTALL_DESTINATION}/72x72/apps/ RENAME ncPong.png)
		install(FILES ${NCPONG_DATA_DIR}/icons/icon48.png DESTINATION ${ICONS_INSTALL_DESTINATION}/48x48/apps/ RENAME ncPong.png)
	endif()
