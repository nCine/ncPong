if(NCPONG_BUILD_ANDROID)
	...
	string(REPLACE ";" "', '" GRADLE_NDK_ARCHITECTURES "${NCPONG_NDK_ARCHITECTURES}")
	...
	if(NCINE_INSTALL_DIR OR NCINE_SHARE_DIR)
		...
		foreach(ARCHITECTURE ${NCPONG_NDK_ARCHITECTURES})
	...
	add_custom_target(ncpong_android ALL)
	set_target_properties(ncpong_android PROPERTIES FOLDER "Android")
	add_dependencies(ncpong_android ncpong)

	foreach(ARCHITECTURE ${NCPONG_NDK_ARCHITECTURES})
		set(ANDROID_BINARY_DIR ${CMAKE_BINARY_DIR}/android/build/ncpong/${ARCHITECTURE})
		...
		add_custom_target(ncpong_android_${ARCHITECTURE} DEPENDS ${ANDROID_BINARY_DIR}/libgame.so)
		set_target_properties(ncpong_android_${ARCHITECTURE} PROPERTIES FOLDER "Android")
		add_dependencies(ncpong_android ncpong_android_${ARCHITECTURE})
	endforeach()

	if (NCPONG_ASSEMBLE_APK)
		...
		if (GRADLE_EXECUTABLE)
			...
			add_custom_target(ncpong_gradle_apk ALL DEPENDS ${CMAKE_BINARY_DIR}/android/build/output/apks/android-debug.apk)
			set_target_properties(ncpong_gradle_apk PROPERTIES FOLDER "Android")
			add_dependencies(ncpong_gradle_apk ncpong_android)
		else()
